...
from common_utils import get_config, LogManager, ValidationUtils
...
class AutoUploader:
    ...
    def upload_folder(self, folder_path: str, version: str, description: str = "",
                     platform: str = None, architecture: str = None,
                     package_type: str = None, is_stable: bool = None,
                     is_critical: bool = None, from_version: str = "") -> bool:
        """
        上传单个文件夹
